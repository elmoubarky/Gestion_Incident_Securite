...
public class JWTAuthentificationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			System.out.println("--------------//recuperation des donnes username et pass en format json-------");
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		String jwt = JWT.create()
				...
				.withSubject(user.getUsername())  //username d'user
				.withArrayClaim("roles", roles.toArray(new String[roles.size()]))  //tableau de string pour les roles
